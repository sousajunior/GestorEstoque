...
//
//    /**
//     * Executa o metodo delete da classe CRUD, passando por parâmetro a tabela,
//     * a coluna e valor para a clausula where. É necessário passar um produto
//     * por parâmetro, ao invocar este método.
//     *
//     * @param produto
//     * @throws SQLException
//     */
    ...
    public List<Produto> selecionarTodos() throws SQLException {
        ...
        while (rs.next()) {
            Produto produto = new Produto(rs.getInt("codigoProduto"), rs.getString("nome"), 
                    ...
                    rs.getDouble("preco"), 
                    ControladorUnidadeMedida.selecionarUnidadesMedida(rs.getInt("unidadeMedida_idunidadeMedida")));
            produtos.add(produto);
        }
        return produtos;
    }
