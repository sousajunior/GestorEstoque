...
public class ControladorProduto {
     ...
     * @throws SQLException 
     */
    public static void updateProdutoPorCodigo(String valores,String valorWhere) throws SQLException{
        
        CRUD.update(nomeTabela, "nome","controladoPorLote","'"+valores+"'",valorWhere);
